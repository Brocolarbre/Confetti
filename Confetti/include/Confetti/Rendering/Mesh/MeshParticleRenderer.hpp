...
namespace cft
{
	...
	public:
		...
		bool loadTextures(AssetRegistry& assetRegistry, const std::vector<unsigned int>& imageIds);
		bool loadMeshes(AssetRegistry& assetRegistry, const std::vector<unsigned int>& modelIds);
