#include "Confetti/ForceField/QuadraticDragForceField.hpp"
...
namespace cft
{
	...
	std::unique_ptr<ForceField> QuadraticDragForceField::clone() const
	{
		return std::make_unique<QuadraticDragForceField>(*this);
	}
