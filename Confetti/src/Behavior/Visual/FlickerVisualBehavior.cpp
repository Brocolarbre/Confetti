...
namespace cft
{
	FlickerVisualBehavior::FlickerVisualBehavior(float minimumBrightness, float maximumBrightness, float speed) :
	...
	void FlickerVisualBehavior::evaluate(float elapsedTime, float normalizedAge, ParticleView& particle)
	{
