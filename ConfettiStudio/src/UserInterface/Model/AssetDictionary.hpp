...
private:
	...
	std::unordered_map<std::string, unsigned int> m_forceFields;
...
public:
	...
	void setForceFieldId(const std::string& name, unsigned int id);
	...
	void removeForceFieldId(const std::string& name);
	...
	unsigned int getForceFieldId(const std::string& name) const;
	...
	std::string getForceFieldName(unsigned int id) const;
	...
	const std::unordered_map<std::string, unsigned int>& getForceFields() const;
};