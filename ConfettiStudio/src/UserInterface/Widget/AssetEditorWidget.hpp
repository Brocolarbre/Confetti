...
public:
	...
	std::optional<unsigned int> m_selectedEffect;
	std::optional<unsigned int> m_selectedEmitter;
	std::optional<std::string> m_selectedNewEffect;
	std::optional<std::string> m_selectedNewEmitter;
