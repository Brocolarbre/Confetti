    ...
    m_deltaTimeChronometer(false)
{
    ...
    m_assetRegistry.addParticleSpawner(0, std::make_unique<cft::ParticleSpawner>(
        std::make_unique<cft::RandomAttributeGenerator<cft::Position>>(glm::vec3(-4.0f), glm::vec3(4.0f), m_randomNumberGenerator),
    ...
    m_assetRegistry.addSpawnPolicy(1, std::make_unique<cft::FixedSpawnPolicy>(50, 1, 1));

    m_assetRegistry.addParticleEmitter(0, cft::ParticleEmitter{ 0, 0, /*0*/1, { }, { }, { } });
