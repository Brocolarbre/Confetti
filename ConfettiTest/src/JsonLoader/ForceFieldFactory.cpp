...
void JsonLoader::registerTypes(JsonFactory<cft::ForceField>& factory)
{
	...
	factory.registerType("Directional", [](const json& data) { return std::make_unique<cft::DirectionalForceField>(data.at("direction").get<Vec3>().value, data.at("strength")); });
	factory.registerType("LinearDrag", [](const json& data) { return std::make_unique<cft::LinearDragForceField>(data.at("strength")); });
	factory.registerType("Orbit", [](const json& data) { return std::make_unique<cft::OrbitForceField>(data.at("spatialInfluence").get<cft::SpatialInfluence>(), data.at("axis").get<Vec3>().value, data.at("strength"), data.at("radius"), data.at("radialCorrectionStrength")); });
	...
	factory.registerType("ShockWave", [](const json& data) { return std::make_unique<cft::ShockWaveForceField>(data.at("spatialInfluence").get<cft::SpatialInfluence>(), data.at("axis").get<Vec3>().value, data.at("speed"), data.at("strength"), data.at("thickness")); });
	...
	factory.registerType("Vortex", [](const json& data) { return std::make_unique<cft::VortexForceField>(data.at("spatialInfluence").get<cft::SpatialInfluence>(), data.at("axis").get<Vec3>().value, data.at("strength"), data.at("pullStrength")); });
	factory.registerType("Wind", [](const json& data) { return std::make_unique<cft::WindForceField>(data.at("direction").get<Vec3>().value, data.at("strength"), data.at("drag")); });
}